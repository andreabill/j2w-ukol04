...
public class VizitkaController {
    ...
    public ModelAndView nova() {
        ModelAndView novaStranka = new ModelAndView("nova");
        return novaStranka;
    }

    @PostMapping(value = "/nova", params = {"jmeno", "firma", "ulice", "obecPsc", "telefon", "email", "web"})
    public String pridatVizitku(Vizitka konkretníVizitka) {
        seznamVizitek.add(konkretníVizitka);
        return "redirect:/";

    }

    @PostMapping(value = "/detail", params = {"id"})
    public String smazatVizitku(int id) {
